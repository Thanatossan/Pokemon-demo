...
abstract class $PokemonEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String? name, String? sprite});
}
...
class _$PokemonEntityImpl implements _PokemonEntity {
  const _$PokemonEntityImpl({required this.id, this.name, this.sprite});
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, name, sprite);
...
abstract class _PokemonEntity implements PokemonEntity {
  const factory _PokemonEntity(
      ...
      final String? name,
      final String? sprite}) = _$PokemonEntityImpl;
